...
public class ChatUI{
	  ...
	  public void doConnect(){
		    if (connect.getText().equals("Connect")){
		    	...
		    	try{
		    		...
		    		client.setGUI(this);
					server1=(ChatServerInt)Naming.lookup("rmi://"+ip.getText()+"/ChatServer");
					server1.login(client);
					updateUsers(server1.getConnected());
  ...
  public ChatUI(){
	    ...
	    frame.setSize(702,600);
	    frame.setVisible(true);  
	    ip.setText("10.73.32.144");
	    name.setText("test");
	    //test();
